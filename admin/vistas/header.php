 ...
 <body class="hold-transition skin-blue sidebar-mini">
   ...
   <div class="fb-customerchat" attribution=setup_tool page_id="280144326139427" theme_color="#263f6a " logged_in_greeting="Hola! deseas compartir algún sistema o descargar ?" logged_out_greeting="Hola! deseas compartir algún sistema o descargar ?">
   </div>
   <div class="wrapper">
     ...
     <header class="main-header">
       ...
       <a href="escritorio.php" class="logo">
         ...
         <span class="logo-mini"><b>CIE</b> FYA</span>
         <!-- <span class="logo-lg"><img src="../files/negocio/logo.png"height="50px"></span> -->
         <span class="logo-lg"><b>Control Equipos</b> FYA</span>
       </a>
     ...
     <aside class="main-sidebar">
       ...
       <section class="sidebar">
         ...
         <ul class="sidebar-menu tree" data-widget="tree">
           ...
           <li><a href="escritorio.php"><i class="fa fa-home" aria-hidden="true"></i> <span>Inicio</span></a></li>
            ...
            ?>
             <li class="treeview">
               ...
               <ul class="treeview-menu">
                 ...
                 <li><a href="tipousuario.php"><i class="fa fa-circle-o"></i> Tipo de Accesos</a></li>
               </ul>
             </li>
             ...
             <li class="treeview">
               <a href="#">
                 <i class="fa fa-desktop" aria-hidden="true"></i><span>Equipos</span>
                 <span class="pull-right-container">
                   <i class="fa fa-angle-left pull-right"></i>
                 </span>
               </a>
               <ul class="treeview-menu">
                 ...
                 <li><a href=""><i class="fa fa-circle-o"></i> Todas de Equipos</a></li>
               </ul>
             </li>

             <li class="treeview">
               <a href="#">
                 <i class="fa fa-area-chart" aria-hidden="true"></i><span>Control de Asistencias</span>
                 <span class="pull-right-container">
                   <i class="fa fa-angle-left pull-right"></i>
                 </span>
               </a>
